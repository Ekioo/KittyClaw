...
## Key components
- `KittyClaw.Core/Automation/AutomationEngine.cs` — main loop; polls triggers and executes matching actions.
...
- `KittyClaw.Core/Automation/ConditionEvaluators.cs` — condition checks gating actions.
