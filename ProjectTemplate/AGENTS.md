...
The KittyClaw background engine reads `automations.json` and launches the selected agent backend (Claude Code, Grok Build, OpenAI Codex, or a local Ollama model) in this working directory. Agents interact with the board via the KittyClaw API above.
