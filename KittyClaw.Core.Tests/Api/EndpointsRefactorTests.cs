...
public sealed class EndpointsRefactorTests : IClassFixture<EndpointsRefactorTests.ApiFactory>, IDisposable
{
    ...
    private static readonly HashSet<string> ExpectedRoutes = new(StringComparer.Ordinal)
    {
        ...
        "GET /api/projects/{slug}/worktree-merges/{requestId}",
        ...
        "POST /api/projects/{slug}/worktree-merges/{requestId}/retry-synchronization",
        // Tickets
    ...
    private static readonly Dictionary<string, string> ExpectedTags = new(StringComparer.Ordinal)
    {
        ...
        ["GET /api/projects/{slug}/worktree-merges/{requestId}"] = "Worktree merges",
        ...
        ["POST /api/projects/{slug}/worktree-merges/{requestId}/retry-synchronization"] = "Worktree merges",
